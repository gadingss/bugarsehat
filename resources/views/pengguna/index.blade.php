                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $roleName = $spatieRoles->first() ?? $user->role ?? 'Member';
                                            @endphp

                                            @if(str_contains(strtolower($roleName), 'owner'))
                                                <span class="badge bg-dark">Owner</span>
                                            @elseif(str_contains(strtolower($roleName), 'staff'))
                                                <span class="badge bg-primary">Staff</span>
                                            @elseif(str_contains(strtolower($roleName), 'trainer'))
                                                <span class="badge bg-success">Trainer</span>
                                            @elseif(str_contains(strtolower($roleName), 'admin'))
                                                <span class="badge bg-danger">Admin</span>
                                            @else
                                                <span class="badge bg-secondary">{{ ucfirst($roleName) }}</span>
                                            @endif
                                        </td>
