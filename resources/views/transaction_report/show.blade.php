                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                <div class="flex-grow-1">
                                    ...
                                    <span class="text-dark fw-bolder fs-6">#{{ str_pad($transaction->id, 6, '0', STR_PAD_LEFT) }}</span>
                                </div>
                            </div>
                            <!--end::Details-->
                            <!--begin::Details-->
                            <div class="d-flex align-items-center mb-5">
                                <div class="flex-grow-1">
                                    ...
                                    <span class="text-dark fw-bolder fs-6">{{ $transaction->transaction_date->format('d F Y H:i') }}</span>
                                </div>
                            </div>
                            <!--end::Details-->
                            <!--begin::Details-->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                <div class="flex-grow-1">
                                    ...
                                    <span class="text-muted fw-semibold d-block fs-7">{{ $transaction->user->email }}</span>
                                </div>
                            </div>
                            <!--end::Details-->
                            <!--begin::Details-->
                            <div class="d-flex align-items-center mb-5">
                                <div class="flex-grow-1">
                                    ...
                                    <span class="text-dark fw-bolder fs-6">{{ $transaction->product->name }}</span>
                                </div>
                            </div>
                            <!--end::Details-->
                            <!--begin::Details-->
                            <div class="d-flex align-items-center mb-5">
                                <div class="flex-grow-1">
                                    ...
                                    <span class="text-dark fw-bolder fs-6">{{ $transaction->validator ? $transaction->validator->name : '-' }}</span>
                                </div>
                            </div>
                            <!--end::Details-->
                        </div>
    ...
    <span class="text-dark fw-bolder fs-6">
        ...
        @endif
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-5">
                            ...
                            <span class="text-dark fw-bolder fs-6">Rp {{ number_format($transaction->amount, 0, ',', '.') }}</span>
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="d-flex justify-content-between align-items-center border-top pt-5">
                            ...
                            <span class="text-dark fw-bolder fs-4">Rp {{ number_format($transaction->amount, 0, ',', '.') }}</span>
                        </div>
                        <!--end::Item-->
                    </div>
                    <!--end::Order details-->
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-end">
                        ...
                        <form action="{{ route('transaction_report.validate', $transaction) }}" method="POST" class="me-3">
                            @csrf
