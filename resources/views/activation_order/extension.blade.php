...
<div class="container mt-4 custom-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3>Perpanjangan Membership</h3>
        <a href="{{ route('activation_order', ['tab' => 'extension']) }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    <div class="form-section">
        <form method="POST" action="{{ route('activation_order.extension.store') }}">
            @csrf
            ...
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-info">
                        <strong>Informasi:</strong> Perpanjangan membership akan dimulai dari tanggal yang dipilih. Pastikan member memiliki membership aktif yang akan segera berakhir.
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save"></i> Buat Perpanjangan
                </button>
            </div>
        </form>
    </div>
