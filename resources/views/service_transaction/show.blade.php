                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('service_transaction') }}" class="text-muted text-hover-primary">Transaksi Layanan</a>
                            </li>
                            <li class="breadcrumb-item">
                                <span class="bullet bg-gray-400 w-5px h-2px"></span>
                            </li>
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p class="fw-bold">{{ $serviceTransaction->transaction_date->format('d F Y H:i') }}</p>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-bold fs-5">{{ $serviceTransaction->service->name ?? 'Layanan tidak tersedia' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="fw-semibold text-gray-600">Jumlah Pembayaran</label>
                                    <p class="fw-bold fs-5 text-primary">Rp {{ number_format($serviceTransaction->amount, 0, ',', '.') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-bold">{{ $serviceTransaction->scheduled_date->format('d F Y H:i') }}</p>
                                </div>
                                @if($serviceTransaction->completed_date)
                                <div class="col-md-6">
                                    <label class="fw-semibold text-gray-600">Tanggal Selesai</label>
                                    <p class="fw-bold">{{ $serviceTransaction->completed_date->format('d F Y H:i') }}</p>
                                </div>
                                @endif
                            </div>
                            @endif
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                @if($serviceTransaction->canCancel() && $serviceTransaction->user_id == Auth::id())
                                    <form action="{{ route('service_transaction.cancel', $serviceTransaction) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="btn btn-danger w-100" onclick="return confirm('Apakah Anda yakin ingin membatalkan transaksi ini?')">
                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <span class="fw-bold">Rp {{ number_format($serviceTransaction->amount, 0, ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="fw-bold text-primary fs-5">Rp {{ number_format($serviceTransaction->amount, 0, ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
