                        ...
                        <div class="card-body">
                            <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path opacity="0.3" d="M22 6.725V7.725C22 8.325 21.6 8.725 21 8.725H18C18.6 8.725 19 9.125 19 9.725C19 10.325 18.6 10.725 18 10.725V15.725C18.6 15.725 19 16.125 19 16.725V17.725H15V16.725C15 16.125 15.4 15.725 16 15.725V10.725C15.4 10.725 15 10.325 15 9.725C15 9.125 15.4 8.725 16 8.725H13C13.6 8.725 14 9.125 14 9.725C14 10.325 13.6 10.725 13 10.725V15.725C13.6 15.725 14 16.125 14 16.725V17.725H10V16.725C10 16.125 10.4 15.725 11 15.725V10.725C10.4 10.725 10 10.325 10 9.725C10 9.125 10.4 8.725 11 8.725H8C8.6 8.725 9 9.125 9 9.725C9 10.325 8.6 10.725 8 10.725V15.725C8.6 15.725 9 16.125 9 16.725V17.725H5V16.725C5 16.125 5.4 15.725 6 15.725V10.725C5.4 10.725 5 10.325 5 9.725C5 9.125 5.4 8.725 6 8.725H3C2.4 8.725 2 8.325 2 7.725V6.725L12 2.725L22 6.725Z" fill="currentColor"/>
                                </svg>
                            </span>
                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">{{ $statistics['total_transactions'] }}</div>
                ...
                <div class="col-xl-3">
                    <div class="card card-xl-stretch">
                        <div class="card-body">
                            ...
                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">Rp {{ number_format($statistics['total_amount'], 0, ',', '.') }}</div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="status" class="form-select">
                                    ...
                                    <option value="validated" {{ request('status') == 'validated' ? 'selected' : '' }}>Berhasil</option>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex justify-content-start flex-column">
                                                <span class="text-dark fw-bold text-hover-primary fs-6">
                                                    {{ $transaction->product->name ?? 'Produk tidak tersedia' }}
                                                </span>
                                                <span class="text-muted fw-semibold text-muted d-block fs-7">
                                                    ID: #{{ $transaction->id }}
                                                </span>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-4">
                                                    <label class="fw-semibold fs-6 text-gray-600">Tanggal Transaksi</label>
                                                    <p class="fw-bold fs-6">{{ $transaction->transaction_date->format('d F Y H:i') }}</p>
                                                </div>
                                                <div class="mb-4">
                                                    <label class="fw-semibold fs-6 text-gray-600">Produk</label>
                                                    <p class="fw-bold fs-6">{{ $transaction->product->name ?? 'Produk tidak tersedia' }}</p>
                                                </div>
                                                <div class="mb-4">
                                                    <label class="fw-semibold fs-6 text-gray-600">Jumlah Pembayaran</label>
                                                    <p class="fw-bold fs-6">Rp {{ number_format($transaction->amount, 0, ',', '.') }}</p>
                                                </div>
                                                <div class="mb-4">
                                                ...
                                                @if($transaction->validator)
                                                <div class="mb-4">
                                                    <label class="fw-semibold fs-6 text-gray-600">Divalidasi Oleh</label>
...
<style>
    @media print {
        .app-header, .app-sidebar, .app-toolbar, .card-toolbar, .btn, .form, .pagination {
