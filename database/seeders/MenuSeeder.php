...
class MenuSeeder extends Seeder
{
    public function run()
    {
        $menus = [
            ...
            ['id' => 3, 'name' => 'Daftar User', 'type' => 'menu', 'order' => 1, 'sub_id' => 2, 'url' => 'pengguna.index'],
            ...
            ['id' => 7, 'name' => 'Katalog Membership', 'type' => 'menu', 'order' => 2, 'sub_id' => 5, 'url' => 'packet_membership'],
            ...
            ['id' => 10, 'name' => 'Kelola Membership', 'type' => 'menu', 'order' => 5, 'sub_id' => 5, 'url' => 'master_membership'],
            ...
            ['id' => 15, 'name' => 'Katalog Layanan', 'type' => 'menu', 'order' => 4, 'sub_id' => 11, 'url' => 'services.index'],
            ...
            ['id' => 30, 'name' => 'Progress Latihan', 'type' => 'menu', 'order' => 7, 'sub_id' => 11, 'url' => 'member.progress.index'],

            ['id' => 18, 'name' => 'Transaksi', 'type' => 'submenu', 'order' => 5, 'is_permission' => true, 'icon' => 'chart'],
            ['id' => 19, 'name' => 'Riwayat Produk', 'type' => 'menu', 'order' => 1, 'sub_id' => 18, 'url' => 'product_transaction'],
            ['id' => 20, 'name' => 'Riwayat Membership', 'type' => 'menu', 'order' => 2, 'sub_id' => 18, 'url' => 'member_transaction'],
            ['id' => 21, 'name' => 'Riwayat Layanan', 'type' => 'menu', 'order' => 3, 'sub_id' => 18, 'url' => 'service_transaction'],
            ...
            ['id' => 27, 'name' => 'Penggajian Trainer', 'type' => 'menu', 'order' => 5, 'sub_id' => 22, 'url' => 'owner.trainer-salary.index'],
            ...
            ['id' => 46, 'name' => 'Gaji Saya', 'type' => 'menu', 'order' => 5, 'sub_id' => 41, 'url' => 'trainer.salary.index'],
        ];
